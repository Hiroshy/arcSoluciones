...
<head>
  ...
  <title><?php  echo "$datos_WebSite[titulo_web_site]".PHP_EOL; ?> | Mantenimiento </title>
  <!-- Favicon -->
  <link rel="icon" href="\assets\media\empresa\<?php  echo "$datos_WebSite[logo_pestana]".PHP_EOL; ?>" type="image/png">
  <!-- Font Awesome 5 -->
  <link rel="stylesheet" href="/admin-/assets/libs/%40fortawesome/fontawesome-pro/css/all.min.css"><!-- Purpose CSS -->
  <link rel="stylesheet" href="/admin-/assets/css/purpose.css" id="stylesheet">
</head>
...
<body>
  ...
  <div class="min-vh-100 h-100vh py-5 d-flex align-items-center bg-gradient-dark">
    <div class="bg-absolute-cover vh-100 overflow-hidden d-none d-md-block">
      <figure class="w-100">
        <img alt="Image placeholder" src="/admin-/assets/img/svg/backgrounds/bg-4.svg" class="svg-inject">
      </figure>
    </div>
    <div class="container position-relative zindex-100">
      <div class="row justify-content-center align-items-center">
        <div class="col-lg-6">
          <h6 class="display-4 mb-3 text-white font-weight-600">ARC SOLUCIONES EN MANTENIMIENTO</h6>
          <p class="lead text-lg text-white mb-5">
            Por le momento estamos realizando cambios en nuestro servidor , para una mejor atención hacia ti.
          </p>
          <a href="tel:" class="btn btn-white btn-icon rounded-pill hover-translate-y-n3">
            <span class="btn-inner--icon"><i class="far fa-phone"></i></span>
            <span class="btn-inner--text">Asesoría</span>
          </a>
        </div>
        <div class="col-lg-6 d-none d-lg-block">
          <figure class="w-100">
            <img alt="Image placeholder" src="/admin-/assets/img/svg/illustrations/instruction-manual.svg" class="svg-inject opacity-8 img-fluid" style="height: 500px;">
          </figure>
        </div>
      </div>
    </div>
  ...
  <script src="/admin-/assets/js/purpose.core.js"></script>
  <!-- Purpose JS -->
  <script src="/admin-/assets/js/purpose.js"></script>
...
<!-- Mirrored from preview.webpixels.io/purpose-application-ui-kit/application/utility/maintenance-mode by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Nov 2020 09:10:17 GMT -->
</html>