...
<head>
  ...
  <title><?php  echo "$datos_WebSite[titulo_web_site]".PHP_EOL; ?> </title>
  <!-- Favicon -->
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-lg-6 px-5 px-lg-0">
          ...
          <p class="lead text-lg text-white mb-5">
            Lo sentimos al parecer estas buscando un recurso que posiblemente hayamos elimnado o no exista.
          </p>
        ...
        <div class="col-lg-6 d-none d-lg-block">
          <figure class="w-100">
            <img alt="Image placeholder" src="/admin-/assets/img/svg/illustrations/design-thinking.svg" class="svg-inject opacity-8 img-fluid" style="height: 500px;">
          </figure>
        </div>
      </div>
    </div>
...
<!-- Mirrored from preview.webpixels.io/purpose-application-ui-kit/application/utility/error-404 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Nov 2020 09:10:16 GMT -->
</html>