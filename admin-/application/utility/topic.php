...
<!-- Mirrored from preview.webpixels.io/purpose-application-ui-kit/application/utility/topic by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Nov 2020 09:10:17 GMT -->
    ...
    <div class="sidenav" id="sidenav-main">
      ...
      <div class="sidenav-user d-flex flex-column align-items-center justify-content-between text-center">
        ...
        <div class="w-100 mt-4 actions d-flex justify-content-between">
          <a href="../user/profile" class="action-item action-item-lg text-white pl-0">
            <i class="far fa-user"></i>
          </a>
          <a href="#modal-chat" class="action-item action-item-lg text-white" data-toggle="modal">
            <i class="far fa-comment-alt"></i>
          </a>
          <a href="../shop/invoices" class="action-item action-item-lg text-white pr-0">
      ...
      <div class="nav-application clearfix">
        ...
        <a href="../shop/invoices" class="btn btn-square text-sm">
        ...
        <a href="../widgets" class="btn btn-square text-sm">
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav flex-row align-items-center">
              ...
              <li class="nav-item dropdown dropdown-animate">
                ...
                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right dropdown-menu-arrow">
                  ...
                  <a href="../shop/orders" class="dropdown-item">
          ...
          <div class="collapse navbar-collapse navbar-collapse-fade" id="navbar-main-collapse">
            <ul class="navbar-nav align-items-lg-center">
              ...
              <!-- Home  -->
              <li class="nav-item ">
                <a class="nav-link pl-lg-0" href="../home">
                  Home
                </a>
              </li>
              <!-- Application menu -->
                ...
                <div class="dropdown-menu dropdown-menu-arrow p-lg-0">
                  ...
                  <div class="p-lg-4">
                    <div class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                      ...
                      <div class="dropdown-menu"><a class="dropdown-item" href="../project/card-listing">
                          Card listing
                        </a>
                        <a class="dropdown-item" href="../project/table-listing">
                          Table listing
                        </a>
                        <a class="dropdown-item" href="../project/overview">
                          Overview
                        </a>
                        <a class="dropdown-item" href="../project/create-new">
                          Create new
                        </a>
                      </div>
                    </div>
                    <div class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                      ...
                      <div class="dropdown-menu"><a class="dropdown-item" href="../task/table-listing">
                          Table listing
                        </a>
                        <a class="dropdown-item" href="../task/kanban-board">
                          Kanban board
                        </a>
                        <a class="dropdown-item" href="../task/create-new">
                          Create new
                        </a>
                      </div>
                    </div>
                    <div class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                      ...
                      <div class="dropdown-menu"><a class="dropdown-item" href="../user/card-listing">
                          Card listing
                        </a>
                        <a class="dropdown-item" href="../user/table-listing">
                          Table listing
                        </a>
                    ...
                    <div class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                      ...
                      <div class="dropdown-menu"><a class="dropdown-item" href="../authentication/login">
                          Login
                        </a>
                        <a class="dropdown-item" href="../authentication/register">
                          Register
                        </a>
                        <a class="dropdown-item" href="../authentication/recover">
                          Recover
                        </a>
                      </div>
                    </div>
                    <div class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                      ...
                      <div class="dropdown-menu"><a class="dropdown-item" href="../account/profile">
                          Profile
                        </a>
                    ...
                    <div class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                      ...
                      <div class="dropdown-menu"><a class="dropdown-item" href="../shop/card-listing">
                          Card listing
                        </a>
                        <a class="dropdown-item" href="../shop/table-listing">
                          Table listing
                        </a>
                        <a class="dropdown-item" href="../shop/product">
                          Product
                        </a>
                        <a class="dropdown-item" href="../shop/orders">
                          Orders
                        </a>
                        <a class="dropdown-item" href="../shop/order-description">
                          Order description
                        </a>
                        <a class="dropdown-item" href="../shop/cart">
                          Cart
                        </a>
                        <a class="dropdown-item" href="../shop/sellers">
                          Sellers
                        </a>
                        <a class="dropdown-item" href="../shop/invoices">
                          Invoices
                        </a>
                        <a class="dropdown-item" href="../shop/invoice-description">
                          Invoice description
                        </a>
                      </div>
                    </div>
                    <div class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                      ...
                      <div class="dropdown-menu"><a class="dropdown-item" href="error-404">
                          Error 404
                        </a>
                        <a class="dropdown-item" href="error-500">
                          Error 500
                        </a>
                        <a class="dropdown-item" href="maintenance-mode">
                          Maintenance mode
                        </a>
                        <a class="dropdown-item" href="faq">
                          Faq
                        </a>
                        <a class="dropdown-item" href="topic">
                          Topic
                        </a>
                      </div>
                    </div>
                  ...
                  <div class="dropdown-menu-links rounded-bottom delimiter-top p-lg-4">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <a href="../google-map" class="dropdown-item">Google map</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <li class="nav-item dropdown dropdown-animate" data-toggle="hover">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg dropdown-menu-arrow p-0">
                  <ul class="list-group list-group-flush">
                    <li>
                      <a href="../../docs/index" class="list-group-item list-group-item-action" role="button">
                    ...
                    <li>
                      <a href="../../docs/components/index" class="list-group-item list-group-item-action" role="button">
                        <div class="media d-flex align-items-center">
                          <!-- SVG icon -->
                          <figure style="width: 50px;">
                  ...
                  <div class="dropdown-menu-links rounded-bottom delimiter-top p-4">
                    <div class="row">
                      <div class="col-sm-6">
                        <a href="../../docs/getting-started/installation" class="dropdown-item">Installation</a>
                        <a href="../../docs/getting-started/file-structure" class="dropdown-item">File structure</a>
                        <a href="../../docs/getting-started/build-tools" class="dropdown-item">Build tools</a>
                        <a href="../../docs/getting-started/customization" class="dropdown-item">Customization</a>
                      </div>
                      <div class="col-sm-6">
                        <a href="../../docs/getting-started/plugins" class="dropdown-item">Using plugins</a>
                        <a href="../../docs/components/index" class="dropdown-item">Components</a>
                        <a href="../../docs/plugins/animate" class="dropdown-item">Plugins</a>
                        <a href="../../docs/support" class="dropdown-item">Support</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="d-flex align-items-center mt-4">
                  <ul class="list-inline">
                    <li class="list-inline-item pr-3">
                      <span class="badge badge-pill badge-soft-info"><i class="far fa-code mr-1"></i>Web Design</span>
                    </li>
                    <li class="list-inline-item pr-3">
              ...
              <div class="card-footer px-md-5 py-4 bg-lighter border-0 delimiter-top">
                ...
                <form class="d-flex justify-content-between">
                  <div>
                    <button class="btn btn-xs btn-secondary" type="submit"><i class="far fa-thumbs-up"></i>
                    </button>
                    <button class="btn btn-xs btn-secondary" type="submit"><i class="far fa-thumbs-down"></i>
                    </button>
                  </div>
                  <div>
...
<!-- Mirrored from preview.webpixels.io/purpose-application-ui-kit/application/utility/topic by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Nov 2020 09:10:18 GMT -->
</html>