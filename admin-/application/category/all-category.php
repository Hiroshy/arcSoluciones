...
<head>
  ...
  <title><?php  echo "$datos_WebSite[titulo_web_site]".PHP_EOL; ?> - Categorias</title>
  <!-- Favicon -->
    ...
    <div class="main-content position-relative">
            ...
            <div class="card card-stats">
              ...
              <div class="card-body">
                ...
                <p class="mt-3 mb-0 text-sm">
                  <span class="badge badge-soft-success mr-2"> <i class="far fa-project-diagram"></i> </span>
                  <span class="text-nowrap">Total de categorias</span>
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    ...
                    <span class="h5 font-weight-bold mb-0">
                      <?php
                        $productos=$productos->sqlquery("SELECT count(*) as producto FROM `producto`");
                        echo $productos[0]['producto']
                      ?>
                    </span>
                  </div>
                  <div class="col-auto">
                ...
                <p class="mt-3 mb-0 text-sm">
                  <span class="badge badge-soft-warning mr-2"><i class="far fa-tasks"></i>
                  </span>
                  <span class="text-nowrap">Total de productos / cursos</span>
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card card-stats">
              ...
              <div class="card-body">
                ...
                <p class="mt-3 mb-0 text-sm">
                  <span class="badge badge-soft-danger mr-2"><i class="fal fa-grin-stars"></i></span>
                  <span class="text-nowrap">Total de interesados</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="card">
          ...
          <div class="card-header actions-toolbar border-0">
            ...
            <div class="row justify-content-between align-items-center">
              <div class="col">
                <h6 class="d-inline-block mb-0">Categorias</h6>
              </div>
                ...
                <div class="actions" >
                    ...
                    <div class="dropdown mr-3">
                      <a href="#" class="action-item" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <a href="/admin-/application/category/new-category" class="action-item mr-3"><i class="fas fa-plus-square"></i></a>
                      </a>
                    </div>
                </div>
              </div>
                ...
                <tr>
                  <th scope="row" class="pd-auto">
                    <div class="avatar-parent-child">
                          <img alt="<?php echo $categoria['categoria']?>" src="<?php echo (strlen($categoria['foto'])>1)?"../../../assets/media/categoria/".$categoria['foto']:'../../../assets/media/logo_arc.png' ?>" class="avatar img-fluid rounded-circle">
                          <span class="avatar-child avatar-badge bg-success"></span>
                    </div>
                  </th>
                  <td>
                      <a href="./new-category?id=<?php echo $categoria['id']?>" class="name h6 mb-0 text-sm"><?php echo $categoria['categoria']?></a> 
                  </td>
                  <td>
                  <?php echo $categoria['resumen']?>
                  </td>
                  <td>
                    <?php echo $categoria['meta_keyword']?>
                  </td>
                  <td>
                    <?php echo $categoria['comentario']?>
                  </td>
                  <td class="text-right">
                  <div class="actions ml-3">
                      <a href="/categoria/<?php echo $categoria['slug']?>" target="_blank" class="action-item mr-2" data-toggle="tooltip" title="Quick view">
                        <i class="far fa-external-link-alt"></i>
                      </a>
                      <a href="./new-category?id=<?php echo $categoria['id']?>" class="action-item mr-2" data-toggle="tooltip" title="Edit">
                        <i class="far fa-pencil-alt"></i>
                      </a>
                      <a href="/admin-/application/category/all-category?id=<?php echo $categoria['id'] ;?>" class="action-item text-danger mr-2" data-toggle="tooltip" title="Move to trash">
      ...
      <?php
                if(isset($_GET['id'])){
                    ...
                    $categorias=new Categoria();
                    $categorias->eliminar($registro);
                    echo '<script>location.href="/admin-/application/category/all-category"</script>';
                }
            ?>
