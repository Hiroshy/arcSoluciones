...
<!-- Mirrored from preview.webpixels.io/purpose-application-ui-kit/application/timeline by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Nov 2020 09:10:18 GMT -->
                ...
                <div class="dropdown-menu dropdown-menu-arrow p-lg-0">
                  ...
                  <div class="p-lg-4">
                    ...
                    <div class="dropdown dropdown-animate dropdown-submenu" data-toggle="hover">
                      ...
                      <div class="dropdown-menu"><a class="dropdown-item" href="utility/error-404">
                          Error 404
                        </a>
                        <a class="dropdown-item" href="utility/error-500">
                          Error 500
                        </a>
                        <a class="dropdown-item" href="utility/maintenance-mode">
                          Maintenance mode
                        </a>
                        <a class="dropdown-item" href="utility/faq">
                          Faq
                        </a>
                        <a class="dropdown-item" href="utility/topic">
                          Topic
                        </a>
                      </div>
                    </div>
